...
// 自提点列表
export const fetchPickLists = (page, size, id) =>
...
export const fetchSeePickPwd = id =>
  axios.get('/appapi.php?c=Merchantapp&a=get_pick_addr_merid', {
    params: {
      id,
      ticket: localStorage.getItem('ticket'),
    },
...
// 删除
export const fetchPickAddressDel = id =>
...
// 自提点列表详情
export const fetchPickAddressDetail = id =>
...
// 自提点密钥
export const fetchChangePicPwd = id =>
  axios.post('/appapi.php?c=Merchantapp&a=change_pic_pwd', {
    pick_id: id,
    ticket: localStorage.getItem('ticket'),
  })
