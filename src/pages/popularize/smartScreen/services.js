...
axios.post('/Appapi.php?g=Appapi&c=Ai_imax&a=pushad_add_by_mer',{
  ...payload,
  ticket: localStorage.getItem('ticket'),
})

// 获取推广内容
export const fetchPromotionInfo = payload => 
axios.get('/Appapi.php?g=Appapi&c=Ai_imax&a=get_pushad_info',{
  ...payload,
  ticket: localStorage.getItem('ticket'),
})
...
axios.post('/Appapi.php?g=Appapi&c=Ai_imax&a= pushad_edit_by_mer',{
  ...payload,
  ticket: localStorage.getItem('ticket'),
})
