...
// 礼品列表
export const fetchGetGift = (page, size, str) =>
...
// 金币商城分类
export const fetchGiftCategory = catFid =>
  axios.get('/appapi.php?c=Merchantapp&a=gift_category', {
    params: {
      cat_fid: catFid,
      ticket: localStorage.getItem('ticket'),
    },
...
export const fetchGiftCategorylist = catFid =>
...
// 金币商城订单
export const fetchGiftOrder = (page, size, giftId) =>
...
// 金币商城详情
export const fetchGiftOrderDetail = orderId =>
...
// 获取
export const fetchGetGiftDetail = giftId =>
...
// 删除
export const fetchDelGift = giftId =>
...
// 发货选择快递
export const fetchExpressList = orderId =>
  axios.post('/appapi.php?c=Merchantapp&a=getGiftExpress', {
    order_id: orderId,
    ticket: localStorage.getItem('ticket'),
  })

// 发货详情列表
export const fetchExpress = orderId =>
  axios.post('/appapi.php?c=Merchantapp&a=getGiftExpress', {
    order_id: orderId,
    ticket: localStorage.getItem('ticket'),
  })
...
export const checkCouponCode = (orderId, giftPass) =>
  axios.post('/appapi.php?c=Merchantapp&a=gift_verify', {
...
export const fecthGiftPassArray = orderId =>
  axios.post('/appapi.php?c=Merchantapp&a=gift_pass_array', {
    order_id: orderId,
    ticket: localStorage.getItem('ticket'),
  })

export const fecthGiftArrayVerify = (orderId, giftPass) =>
