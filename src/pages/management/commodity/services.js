...
export const fetchECommerceLists = (page, size, name) =>
  axios.get('/appapi.php?c=Merchantapp&a=spro', {
    params: {
      page,
      size,
...
export const fetchUserLevel = (storeId, goodid) =>
  axios.post('/appapi.php?c=Merchantapp&a=user_level', {
    store_id: storeId,
    goods_id: goodid,
    ticket: localStorage.getItem('ticket'),
  })
...
// 电商商店
export const fetchStoreValues = type =>
...
export const changeECommerceStand = (storeId, goodsId, status) =>
  axios.post('/appapi.php?c=Merchantapp&a=goods_status', {
    store_id: storeId,
    goods_id: goodsId,
    status,
    ticket: localStorage.getItem('ticket'),
...
export const fetchGoodsCategory = storeId =>
  axios.get('/appapi.php?c=Merchantapp&a=goods_category', {
    params: {
      store_id: storeId,
      ticket: localStorage.getItem('ticket'),
    },
...
export const fetchECommerceDelete = (storeId, goodsId) =>
  axios.post('/appapi.php?c=Merchantapp&a=goods_del', {
    store_id: storeId,
    goods_id: goodsId,
    ticket: localStorage.getItem('ticket'),
  })
...
// 店铺列表
export const fetchShopList = appointType =>
...
export const fetchExpressLists = () =>
  axios.get('/appapi.php?c=Merchantapp&a=select_express_lists', {
    params: {
      ticket: localStorage.getItem('ticket'),
    },
  })
